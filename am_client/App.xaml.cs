...
namespace am_client
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            string error = await Data.MessageDataSource.Load();
        ...
        {
           var cmd=new SettingsCommand("Settings","Settings",(a)=>{
               ShowSettings();
           });
        ...
        public void ShowSettings() 
        {
            ...
            settings.ContentBackgroundBrush = new SolidColorBrush(Windows.UI.Colors.Black);
